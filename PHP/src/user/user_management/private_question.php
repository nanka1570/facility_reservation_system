...
if(isset($_POST['return'])==true){//認証ボタンを押した時textの内容を保持
...
<h1 class=top2>2段階認証</h1>
</head>
<body>
<form action="private_question.php" method="POST">
    <p>ユーザーID　　　
...
<?php
    ...
    {
        include_once "private_question_done.php";
...
?>
<!--<a href="user_login.php">ログインページへ</a>-->
<a href="../../login/user_login.php">ログインページへ</a><br /><br />
<a href="question_reset.php">秘密の質問を忘れた場合</a>
</body>
</html>
