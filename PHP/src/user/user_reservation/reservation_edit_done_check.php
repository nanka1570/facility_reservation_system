...
<html>
    ...
    <body>
        ...
        try{
            ...
            $one_time_user_id = $_POST['user_id'];//
            ...
            if(!is_numeric($number_of_user)){
                print '<br><br><br><br>';
                print'<p class="check">予約人数は半角数字で入力してください。</p>';
            ...
            else
            {
                ...
                if($use_ex=='Y')
                {
                    ...
                    if($one_time_user_id == null){
                        echo '<p class="check">利用者名（ユーザー名）: 管理者</p>';
                    }
                    else{
                        echo '<p class="check">利用者名（ユーザー名）: ' . htmlspecialchars($one_time_user_id) . '</p>';
                    }
                    ...
                    //貸出備品がある場合は表示
                    echo '<p class="check">貸出備品</P>';
                    if($item_name_data!=null){
                        print '<p class="check">';
                        for($display = 0; $display < $item_cnt; $display++){
                            echo $item_name_data[$display].':'.$item_pieces_data[$display].'個<br>';
                        }
                        print '</p>';
                    }
                    else{
                    ...
                    <form method="post" action="reservation_edit_done.php">
