...
<?php
    ...
    print'<p class="font">利用人数を入力してください</p>';
        print'<input type="text"  name="number_of_user">人';
    ...
    print'<p class="font">貸出備品</p>';
        ...
        while($rec == true)
        {
            ...
            print '<td><p><input type="text" name="item_pieces['.$i.']" placeholder="個数" class="item\css"></p></td>';
            print '<td>個</td>';//
            print '</tr>';
    ...
    print'<p class="font">備考欄</p>';
        ...
        print'<p><input type="submit" value="予約確認画面へ" class="color"></p>';
