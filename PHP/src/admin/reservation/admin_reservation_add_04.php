...
if($dateToday == $reserveDate || $reserveDate==""){
    include "user_reservation_add_01.php";
}
else{
                ...
                if($tdnum[$n][$room_reserv]=="reserved"){//前のコマの$tbclassがreserved
                    if(in_array($tbleft,$etou)==false){
                        ...
                        print "<td class=$tdclass>";
                            print'<form method="post" action="admin_reservation_add_04.php">';
                                ...
                                print'<input type="submit" value="予　　約" class="reserv-button">';
                            print'</form>';
                        print "</td>";
                    }
...
print '<section class="section_css">';
    ...
    print'<form method="post" action="admin_reservation_check.php">';
    print'<p>利用者名（ユーザー名）を入力してください</p>';
        print'<p><input type="text" name="one_time_user_id"></p>';
    ...
    print'<p>利用人数を入力してください</p>';
            print'<p><input type="text" name="number_of_user" autofocus>人</p>';
    ...
    print'<p>貸出備品</p>';
        ...
        while($rec == true)
        {
            ...
            print '<p><input type="text" name="item_pieces['.$i.']" placeholder="個数"  class="item_css">個</p>';//
    ...
    print'<p>備考欄</p>';
        ...
        print'<p><input type="submit" class="button_css" value="予約確認画面へ"></p>';
...
print '</section>';
    ...
    print'<form name="form1" method="post" action="admin_reservation_add_02.php">';
...
print '<div class="button-group">';
        ...
        print'<form action="admin_room.php">';
            print'<input type="submit" class="button_css" value="部屋選択画面に戻る">';
        print'</form>';

        print'<form action="../../login/admin_home.php">';
            print'<input type="submit" class="button_css" value="ホーム画面に戻る">';
        print'</form>';
        print '</div>';
}
?>
