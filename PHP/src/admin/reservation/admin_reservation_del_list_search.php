...
<body>
    ...
    print '<div class="content">';
        ...
        if($search_user_name!= null && $search_date != null ){
            ...
            print '<form action="admin_reservation_del_check.php" method="post">'; 
...
print '</div>';
        ...
        print '<input type="button" onclick=location.href="admin_reservation_del_list.php" value="予約状況一覧に戻る">';
