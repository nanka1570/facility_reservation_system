...
<html>
    ...
    print '<div class="content">';
                    ...
                    if($item_name_data!=null){
                        for($display = 0; $display < $item_cnt; $display++){
                            echo '<p>・'.$item_name_data[$display].':'.$item_pieces_data[$display].'個</p>';
                        }
                    }
                    else{
                        echo '<p>なし</P>';
    ...
    print '</div>';
                    ...
                    <form method="post" action="admin_reservation_done.php">
                    ...
                    <button type="submit" name="action" value="Yes" class="button">はい</button>
                    </form>
                    <?php
                    print'<form method="post" action="admin_reservation_add_stop.php">';
                        print'<input type="hidden" name="reservation_number" value="'.$reservation_number.'">';
                        print'<button type="submit" name="action" value="No" class="button">いいえ</button>';
                        // print'<button type="submit" value="いいえ" class="button">';
                    print'</form>';
                //}
                //else
                //{
