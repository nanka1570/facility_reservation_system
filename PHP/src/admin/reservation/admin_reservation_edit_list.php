...
{ 
    ...
    print '<div class="search-section">';
        print '<h2>予約検索</h2>';
        print '<form method="post" action="admin_reservation_edit_list_search.php" class="search-form">';
    ...
    {
        print '<form action="admin_reservation_edit_check.php" method="post" class="reservation-form">'; 
        ...
        print '<div class="button-container">';
            print '<input type="submit" value="選択した予約を変更する" class="edit-button">'; 
        print '</div>';
        print '</form>';
