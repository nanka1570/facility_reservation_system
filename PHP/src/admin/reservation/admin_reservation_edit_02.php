...
if($dateToday == $reserveDate || $reserveDate==""){
    include "admin_reservation_edit_01.php";
}
else{
                ...
                if($tdnum[$n][$room_reserv]=="reserved"){//前のコマの$tbclassがreserved
                    if(in_array($tbleft,$etou)==false){
                        ...
                        print "<td class=$tdclass>";
                            print'<form method="post" action="admin_reservation_edit_04.php">';
 ...
 print '<section class="section_css">';
    ...
    print'<p>貸出備品</p>';
        ...
        while($rec == true)
        {
            ...
            print '<p><input type="text" class="item_css" class="item_css" name="item_pieces['.$i.']" placeholder="個数">個</p><br>';//
